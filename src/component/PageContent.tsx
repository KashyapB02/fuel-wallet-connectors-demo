...
import { useAccounts, useConnectUI, useCurrentConnector, useDisconnect, useIsConnected, useWallet } from "@fuels/react";
...
export function PageContent() {
  ...
  async function signMessage() {
    ...
    if (hasSignMessageCustomCurve(currentConnector)) {
      const { curve, signature } = await currentConnector.signMessageCustomCurve(message);
